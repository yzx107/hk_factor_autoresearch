"""Gate A-safe order-to-trade event ratio factor."""
...
FACTOR_ID = "order_trade_event_ratio_v1"
FACTOR_FAMILY = "order_trade_interaction_pressure"
MECHANISM = "Measure quoting pressure from order-event intensity relative to matched trade intensity."
...
EXPECTED_REGIME = "works better when quoting pressure rises faster than matched execution intensity"
...
OUTPUT_COLUMN = "order_trade_event_ratio_score"
