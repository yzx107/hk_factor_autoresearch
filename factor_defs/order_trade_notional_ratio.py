"""Gate A-safe order-to-trade notional ratio factor."""
...
FACTOR_ID = "order_trade_notional_ratio_v1"
FACTOR_FAMILY = "order_trade_interaction_pressure"
MECHANISM = "Measure displayed order notional pressure relative to matched traded notional."
...
EXPECTED_REGIME = "works better when order notional builds faster than realized turnover"
...
OUTPUT_COLUMN = "order_trade_notional_ratio_score"
