...
FACTOR_ID = "close_vwap_churn_interaction_change_v1"
FACTOR_FAMILY = "order_trade_interaction_pressure"
MECHANISM = "Measure one-day acceleration in 收盘-VWAP 与 churn 交互."
...
EXPECTED_REGIME = "change version of: works better when end-of-day dislocation and order churn rise together"
...
OUTPUT_COLUMN = "close_vwap_churn_interaction_change_score"
LOOKBACK_STEPS = 1
