...
FACTOR_ID = "order_notional_vs_trade_notional_gap_v1"
...
EXPECTED_REGIME = 'works better when displayed order size rises faster than realized matched trade size'
...
OUTPUT_COLUMN = "order_notional_vs_trade_notional_gap_score"
...
def compute_signal(
    ...
    *,
    ...
    if transform == "level":
        return (
            _level_frame(daily)
            .with_columns(pl.col("order_notional_vs_trade_notional_gap_level").alias(OUTPUT_COLUMN))
