...
from factor_defs.close_vwap_churn_interaction import OUTPUT_COLUMN, compute_signal


class CloseVwapChurnInteractionTest(unittest.TestCase):
    def test_compute_signal_prefers_larger_gap_with_higher_churn(self) -> None:
        frame = pl.DataFrame(
            {
