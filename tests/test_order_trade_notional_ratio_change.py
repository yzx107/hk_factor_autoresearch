...
from factor_defs.order_trade_notional_ratio_change import OUTPUT_COLUMN, compute_signal


class OrderTradeNotionalRatioChangeTest(unittest.TestCase):
    def test_compute_signal_tracks_notional_pressure_change(self) -> None:
        frame = pl.DataFrame(
            {
                ...
                "total_order_notional": [1000.0, 2000.0, 5000.0, 1500.0],
