...
from factor_defs.avg_trade_notional_bias_change import OUTPUT_COLUMN, compute_signal


class AvgTradeNotionalBiasChangeTest(unittest.TestCase):
    def test_compute_signal_tracks_day_over_day_avg_notional_shift(self) -> None:
        frame = pl.DataFrame(
            {
                "date": ["2026-03-12", "2026-03-12", "2026-03-13", "2026-03-13"],
                "instrument_key": ["00001", "00002", "00001", "00002"],
                "Price": [10.0, 5.0, 20.0, 5.0],
