...
- 本 repo 当前固定要求 `contains_cross_security_source = false`
- 本 repo 当前固定要求 `universe_filter_version = "stock_research_candidate_filter_v1"`
...
- 是否显式写出 `contains_cross_security_source = false`
- 是否显式写出 `universe_filter_version`
...
- `contains_cross_security_source` 当前必须是 `false`
- `universe_filter_version` 当前必须是 `stock_research_candidate_filter_v1`
