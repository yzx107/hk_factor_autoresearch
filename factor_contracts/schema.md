...
当前 repo 中已有的 `FACTOR_ID`、`FACTOR_FAMILY`、`MECHANISM`、`INPUT_DEPENDENCIES`、
`RESEARCH_UNIT`、`HORIZON_SCOPE`、`VERSION`、`TRANSFORM_CHAIN`、
`EXPECTED_REGIME`、`FORBIDDEN_SEMANTIC_ASSUMPTIONS` 是第一版落地。
...
也就是说，contract schema 先把制度写全，代码实现按最小可行集逐步对齐。
