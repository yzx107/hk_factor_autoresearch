...
- gate_d_id: `layered_gate_d_20260525T152342Z_layered_gate_c_20260524T180031Z_layer_board_20260524T172034Z`
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| `avg_trade_notional_bias` | `research_only_source_gap` | `southbound_split_retest` | `mid_liquid_tradable,small_illiquid_special` / `southbound_unknown` | 0.007680 | 0.687500 | 0.670431 | 0.687500 | 16 |
| `avg_trade_notional_bias_change` | `research_only_source_gap` | `layer_explicit_rewrite` | `small_illiquid_special` / `southbound_unknown` | 0.006574 | 0.687500 | 0.763593 | 0.687500 | 16 |
| `order_notional_vs_trade_notional_gap_change` | `research_only_source_gap` | `layer_explicit_rewrite` | `small_illiquid_special` / `southbound_unknown` | 0.008205 | 0.625000 | 0.753356 | 0.625000 | 16 |
| `order_trade_notional_ratio` | `research_only_source_gap` | `layer_explicit_rewrite` | `small_illiquid_special` / `southbound_unknown` | 0.019755 | 0.750000 | 0.821692 | 0.750000 | 16 |
