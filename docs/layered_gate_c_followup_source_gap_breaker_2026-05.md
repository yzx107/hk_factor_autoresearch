...
- factor_count: `6`
- gate_c_summary_path: `runs/layered_gate_c_20260525T153513Z_layer_board_20260524T172034Z/layered_gate_c_summary.json`
...
| --- | --- | --- | --- | --- | --- | ---: |
| `avg_trade_notional_bias` | `needs_southbound_split` / `inverse_candidate` | `southbound_split_retest` | `mid_liquid_tradable`, `small_illiquid_special` | `southbound_not_eligible` | `split_passing_southbound_bucket_then_retest` | 0.005295 |
...
| `avg_trade_notional_bias_change` | `needs_layer_split` / `inverse_candidate` | `layer_explicit_rewrite` | `small_illiquid_special` | `southbound_not_eligible` | `rewrite_factor_as_layer_explicit_spec` | 0.003905 |
| `order_notional_vs_trade_notional_gap_change` | `needs_layer_split` / `as_is_candidate` | `layer_explicit_rewrite` | `small_illiquid_special` | `southbound_not_eligible` | `rewrite_factor_as_layer_explicit_spec` | 0.002958 |
...
| `order_trade_notional_ratio` | `needs_layer_split` / `as_is_candidate` | `layer_explicit_rewrite` | `small_illiquid_special` | `southbound_not_eligible` | `rewrite_factor_as_layer_explicit_spec` | 0.004197 |

## Guardrails

- `southbound_split_retest` must separate eligible, not-eligible, and unknown flow before promotion.
